...
public class FormEditPage extends Page {
	...
	private final JLabel llv = new JLabel("Lv");
	private final JLabel lhp = new JLabel("HP");
	private final JLabel lhb = new JLabel("HB");
	private final JLabel lsp = new JLabel(Page.get(1, "speed"));
	private final JLabel lra = new JLabel(Page.get(1, "range"));
	private final JLabel lwd = new JLabel(Page.get(1, "width"));
	private final JLabel lsh = new JLabel(Page.get(1, "shield"));
	private final JLabel ltb = new JLabel(Page.get(1, "TBA"));
	private final JLabel lbs = new JLabel(Page.get(1, "tbase"));
	private final JLabel ldr = new JLabel(Page.get(1, "price"));
	private final JLabel lrs = new JLabel(Page.get(1, "CD"));
	...
	private final JLabel lpst = new JLabel(Page.get(1, "postaa"));
	private final JLabel vpst = new JLabel();
	private final JLabel litv = new JLabel(Page.get(1, "atkf"));
	private final JLabel vitv = new JLabel();
	private final JLabel ldps = new JLabel("DPS");
