...
public class ImgCore
{
	...
	private static final Object[][] VALS = new Object[][] { { KAS, KAD, KAQ }, { KCS, KCD, KCQ }, { KFS, KFD, KFQ }, { KIS, KID, KIQ } };
	...
	protected static void drawImg(Graphics2D g, BufferedImage bimg, P piv, P sc, double opa, boolean glow, double extend)
	{
